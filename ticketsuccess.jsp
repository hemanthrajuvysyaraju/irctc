...
<body>
	<table
		style="text-align: center; border: 1px dotted red; border-collapse: collapse;">
		...
		<tr>
			<td align="center" colspan="5">
				<table
					style="border: 1px ridge black; text-align: center; border-collapse: collapse;">
					<tr>
						<th>s.no</th>
